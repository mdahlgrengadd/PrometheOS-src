...
export const rules = {
  ...
  init: "As a helpful AI assistant, you should greet the user warmly and offer assistance with running tools or applications. Be ready to help with any tasks they need, whether it's executing functions, managing applications, or answering questions. Always maintain a friendly and professional demeanor.",
};
