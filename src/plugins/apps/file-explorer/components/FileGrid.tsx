        ...
        <div
          ...
          onClick={(e) => {
            ...
            if (e.ctrlKey || e.metaKey) {
              ...
              const lastSelectedIndex = itemsList.indexOf(
                lastSelectedItem || ""
              );
          ...
          onContextMenu={(e) => {
            ...
            // Get the file explorer container's bounding rect to account for window position
            ...
            setShowContextMenu({ x: adjustedX, y: adjustedY, itemId: item.id });
          }}
          draggable={true}
          ...
          <div className="flex flex-col items-center text-center">
            <div className="w-12 h-12 flex items-center justify-center mb-2">
              {React.cloneElement(getFileIcon(item), {
                className: `w-8 h-8 ${
                  selectedItems.has(item.id) ? "drop-shadow-sm" : ""
                }`,
              })}
            </div>
            <span
