...
const LegacyDesktop = () => {
  ...
  useEffect(() => {
    ...
    console.log("[LegacyDesktop] Apps to launch from URL:", appsToLaunch);

    appsToLaunch.forEach(({ appId, initFromUrl }) => {
      console.log(
        `[LegacyDesktop] Opening app ${appId}${
    ...
    if (
      ...
      console.log(
        "[LegacyDesktop] Opening plugin with init URL (legacy):",
        pluginInit
      );
  ...
  return (
    <div className="desktop legacy-desktop">
