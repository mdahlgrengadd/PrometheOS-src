...
const lightTheme: ThemeConfig = {
  id: 'light',
  name: 'Modern Light',
  desktopBackground: 'linear-gradient(to bottom right, hsl(240, 75%, 98%), hsl(240, 20%, 95%))',
  cssVariables: {
    // Window variables
    ...
    '--header-height': '36px',
    '--header-width': '100%',
    '--header-border-radius': 'calc(var(--radius) - 1px) calc(var(--radius) - 1px) 0 0',
...
const darkTheme: ThemeConfig = {
  id: 'dark',
  name: 'Modern Dark',
  desktopBackground: 'linear-gradient(to bottom right, hsl(240, 20%, 10%), hsl(240, 20%, 2%))',
  cssVariables: {
    // Window variables
